...
public class StoreEleven extends AppCompatActivity {
    ConnenctToMSSQL connenctToMSSQL = new ConnenctToMSSQL();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.storeeleven);
        InitialComponent();
    ...
    private void viewData(){
        connenctToMSSQL.getdata1("select fName,fPhone,fEmail,fAddress from tMember where fIdentity = 1 and fAccount = 'iii18'");
    }
