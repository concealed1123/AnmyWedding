...
public class ActPhotoServices extends AppCompatActivity {
    ...
    private View.OnClickListener btnNext_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoServices.this,ActMakeUp.class));
    ...
    private View.OnClickListener btnLast_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoServices.this,ActPayment.class));
    ...
    private View.OnClickListener btnList_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoServices.this,ActWeddingPhoto.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actphotoservices);
        InitialComponent();
    }
