 ...
 * {@link BrideSecEvaluation_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BrideSecEvaluation_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BrideSecEvaluation_Fragment extends Fragment {
    ...
    private View.OnClickListener btnNext_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(getContext(),"你選了新祕的報價能提供哪些服務",Toast.LENGTH_SHORT).show();
    ...
    private View.OnClickListener btnPrevious_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(getContext(),"你選了新秘的作品透露了？",Toast.LENGTH_SHORT).show();
    ...
    public BrideSecEvaluation_Fragment() {
     ...
     * @return A new instance of fragment BrideSecEvaluation_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BrideSecEvaluation_Fragment newInstance(String param1, String param2) {
        BrideSecEvaluation_Fragment fragment = new BrideSecEvaluation_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.bridesecevaluation_fragment, container, false);
    }
