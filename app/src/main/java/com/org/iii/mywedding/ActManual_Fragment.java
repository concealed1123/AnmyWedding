 ...
 * {@link ActManual_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ActManual_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActManual_Fragment extends Fragment {
    ...
    private View.OnClickListener ImgBtnWeddingPhoto_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //startActivity(new Intent(getActivity(),ActWeddingPhoto_Fragment.class));
     ...
     * @return A new instance of fragment ActManual_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ActManual_Fragment newInstance(String param1, String param2) {
        ActManual_Fragment fragment = new ActManual_Fragment();
...
*/
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ImgBtnWeddingPhoto = (ImageButton) getActivity().findViewById(R.id.ImgBtnWeddingPhoto);
        ImgBtnWeddingPhoto.setOnClickListener(ImgBtnWeddingPhoto_click);
        ImgBtnWeddingRec = (ImageButton) getActivity().findViewById(R.id.ImgBtnWeddingRec);
        ImgBtnWeddingRec.setOnClickListener(ImgBtnWeddingRec_click);
        ImgBtnBrideSec = (ImageButton) getActivity().findViewById(R.id.ImgBtnBrideSec);
        ImgBtnBrideSec.setOnClickListener(ImgBtnBrideSec_click);
        ImgBtnWeddingPlace = (ImageButton) getActivity().findViewById(R.id.ImgBtnWeddingPlace);
        ImgBtnWeddingPlace.setOnClickListener(ImgBtnWeddingPlace_click);
    }
    ImageButton ImgBtnWeddingPhoto;
    ImageButton ImgBtnWeddingRec;
    ImageButton ImgBtnBrideSec;
