...
public class CWeddingSite extends AppCompatActivity {
    ...
    ArrayList<CWeddingSiteCollection>arrayList;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new ReadJSON().execute("http://ec2-13-114-47-63.ap-northeast-1.compute.amazonaws.com/processCWeddingSite.ashx");
            }
        });
    }
    class ReadJSON extends AsyncTask<String,Integer,String>{
        ...
        protected void onPostExecute(String content) {
            try {
                ...
                JSONArray jsonArray = jsonObject.getJSONArray("CWeddingSite");
                for(int i=0;i<jsonArray.length();i++){
                    ...
                    arrayList.add(new CWeddingSiteCollection(CollectionName,CollectionImg,CollectionDes));
                }
