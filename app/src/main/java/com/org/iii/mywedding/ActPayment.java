...
public class ActPayment extends AppCompatActivity {
    private View.OnClickListener btnFirst_click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            startActivity(new Intent(ActPayment.this,ActPhotoServices.class));
    ...
    private View.OnClickListener btnPrevious_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPayment.this,ActChooseDressandBorrow.class));
    ...
    private View.OnClickListener btnList_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPayment.this,ActWeddingPhoto.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actpayment);
        InitialComponent();
    }
