...
public class ActPhotoProduction extends AppCompatActivity {
    private View.OnClickListener btnFirst_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActPhotoServices.class));
    ...
    private View.OnClickListener btnNext_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActGiftandLendThings.class));
    ...
    private View.OnClickListener btnPrevious_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActMakeUp.class));
    ...
    private View.OnClickListener btnLast_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActPayment.class));
    ...
    private View.OnClickListener btnList_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActWeddingPhoto.class));
    ...
    private View.OnClickListener btnHome_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            startActivity(new Intent(ActPhotoProduction.this,ActNavi.class));
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actphotoproduction);
        InitialComponent();
    }
